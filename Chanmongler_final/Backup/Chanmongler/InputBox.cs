...
/*  This code was written by David Piepgrass, as a
 *  reply to a CodeProject submission. The code did
 *  not have any explicit license attached to it, so
 *  I'm assuming that I'm allowed to borrow it.
 */
...
namespace System.Windows.Forms {
    ...
    public class InputBox {
        static public string Show(string Prompt) { return Show(Prompt, null, null, int.MinValue, int.MinValue); }
        static public string Show(string Prompt, string Title, string Default) { return Show(Prompt, Title, Default, int.MinValue, int.MinValue); }
